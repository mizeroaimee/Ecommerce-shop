export class ShoppingCart {
    ...
    addItem(dessert, quantity = 1) {
        ...
        if (existingItem) {
            const updatedItem = Object.assign(Object.assign({}, existingItem), { quantity: existingItem.quantity + quantity });
    ...
    updateQuantity(dessertId, newQuantity) {
        ...
        const updatedItem = Object.assign(Object.assign({}, item), { quantity: newQuantity });
     ...
     */
    getTotal(taxRate = 0) {
        const subtotal = Array.from(this.items.values()).reduce((sum, item) => sum + item.dessert.price * item.quantity, 0);
